							...
							<div class="submit-ctn mg-top">
								<div class="left pull-left">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input name="mileage" id="mileage" type="text" readonly="readonly" class="form-control allow" placeholder="里程" autocomplete="off" required value="<?php echo $result['mileage']; ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label" for="cost_price"><p>购车总价</p></label>
										<div class="col-sm-10">
											<input name="cost_price" id="cost_price" type="text" readonly="readonly" class="form-control allow" placeholder="购车总价" autocomplete="off" required value="<?php echo $result['cost_price']; ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label" for="price"><p>售价</p></label>
										<div class="col-sm-10">
											<input name="price" id="price" type="text" readonly="readonly" class="form-control allow" placeholder="售价" autocomplete="off" required value="<?php echo $result['price']; ?>">
										</div>
									</div>
								</div>
